...
import {InvestmentReqDataViewComponent} from "./components/investment-req-data-view.component";
...
@NgModule({
  ...
  declarations: [InvestmentReqDataViewComponent],
  exports: [InvestmentReqDataViewComponent]
})
export class InvestmentReqModule { }
