...
import {StartupsDataViewComponent} from "./startups-data-view.component";
...
@NgModule({
  ...
  declarations: [StartupsDataViewComponent],
  exports: [StartupsDataViewComponent]
})
export class StartupsDataModule { }
